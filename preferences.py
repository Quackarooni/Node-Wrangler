...
kmi_defs = (
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'NUMPAD_0', 'PRESS', False, False, True,
        (('blend_type', 'MIX'),), "Batch Change (Mix)"),
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'NUMPAD_PLUS', 'PRESS', False, False, True,
        (('blend_type', 'ADD'), ('math_operation', 'ADD'), ('vector_operation', 'ADD'), ('bool_operation', 'OR'),), "Batch Change (Add)"),
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'NUMPAD_ASTERIX', 'PRESS', False, False, True,
        (('blend_type', 'MULTIPLY'), ('math_operation', 'MULTIPLY'), ('vector_operation', 'MULTIPLY'), ('bool_operation', 'AND'),), "Batch Change (Multiply)"),
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'NUMPAD_MINUS', 'PRESS', False, False, True,
        (('blend_type', 'SUBTRACT'), ('math_operation', 'SUBTRACT'), ('vector_operation', 'SUBTRACT'), ('bool_operation', 'NIMPLY'),), "Batch Change (Subtract)"),
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'NUMPAD_SLASH', 'PRESS', False, False, True,
        (('blend_type', 'DIVIDE'), ('math_operation', 'DIVIDE'), ('vector_operation', 'DIVIDE'),  ('bool_operation', 'NOT'),), "Batch Change (Divide)"),
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'COMMA', 'PRESS', False, False, True,
        (('math_operation', 'LESS_THAN'),), "Batch Change (Less Than)"),
    (operators.NWBatchChangeNodes.bl_idname, 'PERIOD', 'PRESS', False, False, True,
        (('math_operation', 'GREATER_THAN'),), "Batch Change (Greater Than)"),
    (operators.NWBatchChangeNodes.bl_idname, 'UP_ARROW', 'PRESS', False, False, True,
        (('blend_type', 'PREV'), ('math_operation', 'PREV'), ('vector_operation', 'PREV'), ('bool_operation', 'PREV'),), "Batch Change (Previous)"),
    (operators.NWBatchChangeNodes.bl_idname, 'DOWN_ARROW', 'PRESS', False, False, True,
        (('blend_type', 'NEXT'), ('math_operation', 'NEXT'), ('vector_operation', 'NEXT'), ('bool_operation', 'NEXT'),), "Batch Change (Next)"),
