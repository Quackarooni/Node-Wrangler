...
kmi_defs = (
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'NUMPAD_PLUS', 'PRESS', False, False, True,
        (('blend_type', 'ADD'), ('operation', 'ADD'), ('vector_operation', 'ADD'), ('bool_type', 'OR'),), "Batch Change (Add)"),
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'NUMPAD_ASTERIX', 'PRESS', False, False, True,
        (('blend_type', 'MULTIPLY'), ('operation', 'MULTIPLY'), ('vector_operation', 'MULTIPLY'), ('bool_type', 'AND'),), "Batch Change (Multiply)"),
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'NUMPAD_MINUS', 'PRESS', False, False, True,
        (('blend_type', 'SUBTRACT'), ('operation', 'SUBTRACT'), ('vector_operation', 'SUBTRACT'), ('bool_type', 'NIMPLY'),), "Batch Change (Subtract)"),
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'NUMPAD_SLASH', 'PRESS', False, False, True,
        (('blend_type', 'DIVIDE'), ('operation', 'DIVIDE'), ('vector_operation', 'DIVIDE'),  ('bool_type', 'NOT'),), "Batch Change (Divide)"),
    ...
    (operators.NWBatchChangeNodes.bl_idname, 'COMMA', 'PRESS', False, False, True,
        (('operation', 'LESS_THAN'),), "Batch Change (Less Than)"),
    (operators.NWBatchChangeNodes.bl_idname, 'PERIOD', 'PRESS', False, False, True,
        (('operation', 'GREATER_THAN'),), "Batch Change (Greater Than)"),
    (operators.NWBatchChangeNodes.bl_idname, 'UP_ARROW', 'PRESS', False, False, True,
        (('blend_type', 'PREV'), ('operation', 'PREV'), ('vector_operation', 'PREV'), ('bool_type', 'PREV'),), "Batch Change (Previous)"),
    (operators.NWBatchChangeNodes.bl_idname, 'DOWN_ARROW', 'PRESS', False, False, True,
        (('blend_type', 'NEXT'), ('operation', 'NEXT'), ('vector_operation', 'NEXT'), ('bool_type', 'NEXT'),), "Batch Change (Next)"),
